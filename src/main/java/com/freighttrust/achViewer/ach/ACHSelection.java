...
public class ACHSelection implements Transferable, ClipboardOwner {
  ...
  /**
   * A <code>Transferable</code> which implements the capability required to transfer an <code>
   * ACHRecord</code>.
   *
   * @see java.awt.datatransfer.DataFlavor#stringFlavor
   */
  public static final DataFlavor achRecordFlavor = new DataFlavor(ACHRecord.class, "ACHRecord");

  private static final DataFlavor[] flavors = {achRecordFlavor, DataFlavor.stringFlavor};
   ...
   * <code>DataFlavor.stringFlavor</code> is properly supported. Support for <code>
   * DataFlavor.plainTextFlavor</code> is <b>deprecated</b>.
   *
   ...
   * @return true if <code>flavor</code> is equal to <code>DataFlavor.stringFlavor</code>; false if
