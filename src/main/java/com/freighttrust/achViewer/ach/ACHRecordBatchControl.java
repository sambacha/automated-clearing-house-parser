...
public class ACHRecordBatchControl extends ACHRecord {
  ...
  /** @param entryAddendaCount The entryAddendaCount to set. */
  ...
  /** @param entryHash The entryHash to set. */
  ...
  /** @param messageAuthCode The messageAuthCode to set. */
  ...
  /** @param originatingDfiId The originatingDfiId to set. */
  ...
  /** @param totCreditDollarAmt The totCreditDollarAmt to set. */
  ...
  /** @param totDebitDollarAmt The totDebitDollarAmt to set. */
