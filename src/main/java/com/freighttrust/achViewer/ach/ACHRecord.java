...
public class ACHRecord {
  ...
  public static final char FILE_HEADER_TYPE = '1';

  public static final char BATCH_HEADER_TYPE = '5';

  public static final char ENTRY_DETAIL_TYPE = '6';

  public static final char ADDENDA_TYPE = '7';

  public static final char BATCH_CONTROL_TYPE = '8';

  public static final char FILE_CONTROL_TYPE = '9';
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("File " + achFile.getPath() + " could not be opened");
      System.exit(-1);
    }
  ...
  public boolean isFileHeaderType() {
    if (recordTypeCode == FILE_HEADER_TYPE) return true;
    else return false;
  }

  public boolean isBatchHeaderType() {
    if (recordTypeCode == BATCH_HEADER_TYPE) return true;
    else return false;
  }

  public boolean isEntryDetailType() {
    if (recordTypeCode == ENTRY_DETAIL_TYPE) return true;
    else return false;
  }

  public boolean isAddendaType() {
    if (recordTypeCode == ADDENDA_TYPE) return true;
    else return false;
  }

  public boolean isBatchControlType() {
    if (recordTypeCode == BATCH_CONTROL_TYPE) return true;
    else return false;
  }

  public boolean isFileControlType() {
    if (recordTypeCode == FILE_CONTROL_TYPE) return true;
    else return false;
  }
  ...
  protected String formatString(String inputString, int size) {
    return ((inputString == null ? "" : inputString) + spaceFill(size)).substring(0, size);
  }
  ...
  public static String formatACHDecimal(
      String inputString, String formatString, long defaultValue) {
