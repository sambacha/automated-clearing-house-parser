...
public class ACHRecordFileHeader extends ACHRecord {
  ...
  /** @param blockingFactor The blockingFactor to set. */
  ...
  /** @param fileIdModifier The fileIdModifier to set. */
  ...
  /** @param immediateDestination The immediateDestination to set. */
  ...
  /** @param immediateDestinationName The immediateDestinationName to set. */
  public void setImmediateDestinationName(String immediateDestinationName) {
    this.immediateDestinationName = formatString(immediateDestinationName, 23);
  }
  ...
  /** @param immediateOrigin The immediateOrigin to set. */
  ...
  /** @param immediateOriginName The immediateOriginName to set. */
