...
public class ACHRecordAddenda extends ACHRecord {
  ...
  /** @param addendaSeqNbr The addendaSeqNbr to set. */
  ...
  /** @param addendaTypeCode The addendaTypeCode to set. */
  ...
  /** @param entryDetailSeqNbr The entryDetailSeqNbr to set. */
  ...
  /** @param paymentRelatedInfo The paymentRelatedInfo to set. */
