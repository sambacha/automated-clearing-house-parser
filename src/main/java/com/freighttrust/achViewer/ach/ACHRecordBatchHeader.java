...
public class ACHRecordBatchHeader extends ACHRecord {
  ...
  /** @param companyDescriptiveDate The companyDescriptiveDate to set. */
  ...
  /** @param companyDiscretionaryData The companyDiscretinaryData to set. */
  ...
  /** @param effectiveEntryDate The effectiveEntryDate to set. */
  ...
  /** @param companyEntryDescription The companyEntryDescription to set. */
  ...
  /** @param originationDfiId The originationDfiId to set. */
  ...
  /** @param originatorStatusCode The originatorStatusCode to set. */
  ...
  /** @param serviceClassCode The serviceClassCode to set. */
  ...
  /** @param standardEntryClassCode The standardEntryClassCode to set. */
