...
public class ACHRecordEntryDetail extends ACHRecord {
  ...
  /** @param addendaRecordInd The addendaRecordInd to set. */
  ...
  /** @param dfiAcctNbr The dfiAcctNbr to set. */
  ...
  /** @param individualIdNbr The individualIdNbr to set. */
  ...
  /** @param receivingDfiId The receivingDfiId to set. */
